 ...
 */
public abstract class AnetBaseActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        if (!(this instanceof LoginActivity2) && AnetSingleton.merchant == null) {
                ...
                .setAction(actionId, new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (activity instanceof LoginActivity2) {
                            ((LoginActivity2) activity).attemptLogin();
