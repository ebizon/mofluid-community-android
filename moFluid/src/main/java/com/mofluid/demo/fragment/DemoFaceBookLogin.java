...
/**
 * Created by ebizon on 14/12/15.
 */
public class DemoFaceBookLogin extends Fragment {
    ...
    private final FacebookCallback<LoginResult> callback = new FacebookCallback<LoginResult>() {
        ...
        public void onSuccess(LoginResult loginResult) {
            ...
            Toast.makeText(getActivity(), "sucess" + accessToken, Toast.LENGTH_SHORT).show();
        }
