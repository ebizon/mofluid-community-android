...
public class GetBannerDetails {
    ...
    private static ArrayList<BannerItem> bannerListData;

    public ArrayList<BannerItem> getBannerDetails(JSONArray imageJSNArray)
    {

        if(imageJSNArray==null)
            imageJSNArray= new JSONArray();
